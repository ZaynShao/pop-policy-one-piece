...
### 7.3 下一步 = 第 9 章 · 里程碑与分期 OR 第 10 章术语表

**两条可选路径**:

**路径 A · 继续主线推第 9 章**(里程碑与分期)
- 核心内容:V0.1 内测 / V0.5 试点 / V1.0 GA / V1.1 / V1.2 分期目标与工作量估算
- 素材已充足:第 3 章 MVP 范围(48 个 P0)+ F1-F12 候选池
- 偷懒版:列分期里程碑表 + 各期验收标准,参考 HANDOFF §4 的 16-22 周工作量估算
- 正式版:逐项拍板每期范围,工作量可控

**路径 B · 推第 10 章**(术语表)
- 需要覆盖的词条(备忘箱待入第 10 章区):工具 / 政策主题 / 覆盖清单 / "点"的 5 种语义 / "区"的精确含义 / 泛地域标签
- 完全机械整理,可偷懒版 30 分钟

**建议**:**A 先推第 9 章,再顺推第 10 章收尾**。第 9 章需要你对工作量 / 发布节奏有主观判断,是主线推进的实质章节;第 10 章纯整理,放最后机械过一下即可。完成后整个用户版 PRD 定稿,可启动 `docs/PRD-comparison.md` 正式对比矩阵(T4)。

备忘箱当前未兑现:
- **G 类**:G4(监管风险粒度)/ G9(周观测公式)—— 共 2 项(G13/G20/G28/G12 均已处理)
- **H 类**:全部已处理
- **I 类**:全部已处理
- **F 类**:F1-F12 候选功能(12 项,待入第 9 章里程碑)
