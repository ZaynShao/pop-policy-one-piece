...
**用户版 PRD**:**9/11 章完结 = 82%**
- 0-9 章全部定稿 —— 产品愿景 / 角色 / 场景 / 功能模块 / 数据模型 / 权限矩阵 / 信息架构 / 非功能 / 外部依赖 / **里程碑与分期**
- 剩:**第 10 章术语表**(纯机械整理 30 分钟内)

**AI 版 PRD**:`docs/PRD-ai-led.md` 已入库(768 行),用户未看,主对话已读
**AI 版差异速览**:`docs/PRD-comparison-notes.md`(365 行,非正式笔记,D1-D8 维度)
**正式对比矩阵 `docs/PRD-comparison.md`**:尚未开始,T4 阶段;**应在用户版第 10 章完结后再启动**(现在最近)

**分支状态**:`claude/sad-kalam-a20dee`,ahead of origin/main by 6 commits(第 5 / 6 / 7 / 8 章 + HANDOFF 重启 + 第 9 章)

**备忘箱未兑现**:
- G 类:**全部已处置**(G4 / G9 归第 9 章 9.5)
- H 类 / I 类:全部已处理
...
- 第 9 章末尾(9.末 兑现清单)—— 了解最近一次定稿位置
- 备忘箱"待入第 10 章 · 术语表"区 —— 了解词条素材(4 条已登记)
...
读完后,不要立刻动手,先一句话复述:**"9/11 章完结,剩第 10 章术语表(纯机械 30 分钟内)。F1-F12 全部已分期,G 类全部已处置。对比矩阵 T4 等第 10 章完结后即刻启动。"**

然后直接问是否起第 10 章(无需再给路径选择,只剩这一条路 + 之后的 T4)。

### 7.6 第 10 章的素材 + T4 就绪状态

**第 10 章 · 术语表**(纯整理,机械 20-30 分钟)

词条素材在备忘箱"待入第 10 章"区已登记 4 条:
- 工具 vs 工具包
- 政策主题 / 覆盖清单 / 政策档案
- "点"的 5 种语义(地理点 / 政策点 / 图钉 / 蓝点 / 红黄绿点)
- "区"的精确含义

还可以从 PRD 正文提炼 6-8 条(如:涂层 / 蓝点转色 / 级联匹配 / 泛地域绑定 / ExportRecord / 综合看板 / 周观测 / 属地硬隔离 等)。目标 10-12 个词条。

**T4 · 对比矩阵 `docs/PRD-comparison.md`**

- **前置就绪**:用户版 0-9 章已定稿,第 10 章完稿后即刻可启
- **素材就绪**:`docs/PRD-comparison-notes.md` 已覆盖 D1-D8 维度速览
- **工作量**:3-4 小时(用户+主对话共同)
- **产出形态**:正式版对比矩阵(8 维度 × 逐章 × 差异点 + 整合建议)
- **元学习最终交付**:按 `dual-prd-protocol.md` §8 的 5 题由用户填写(见 `PRD-comparison-notes.md` §9 候选答案预填)
...
| 6 commits | 3402260 / 3230662 / dbe482f / 45eb339 / 8db0577 / (本次第 9 章) | ahead of main |
...
## 9. 给新会话 Claude 的开场建议(2026-04-23 夜重启后更新)

读完本文档 + `docs/PRD-user-led.md` 末尾两处 + `docs/PRD-comparison-notes.md` 后,**不要立刻动手干活**。先做两件事:

1. **一句话确认理解**:"9/11 章完结,剩第 10 章术语表(纯机械 30 分钟内)。F1-F12 全部已分期,G 类全部已处置。对比矩阵 T4 等第 10 章完结后即刻启动。分支 ahead of main by 6 commits。"

2. **只剩一条路径,直接问是否起第 10 章**:
   - **第 10 章术语表**:备忘箱已有 4 条词条素材 + 从 PRD 正文补 6-8 条 → 目标 10-12 条;机械整理 30 分钟内
   - **之后立即进入 T4 对比矩阵**(3-4 小时,双人协作)
...
- 不要擅自跳过第 10 章直接做 T4(第 10 章是 T4 的前置)
