...
### 7.3 下一步 = 第 3 章 3.末(MVP 范围总览 + 工作量感知)+ 进入第 4 章

**第 3 章当前状态**:
- A / B / C 模块**正式定稿**(用户逐项拍板)
- D / E / F / G / H / I / J 模块为 **⚠️ 偷懒版完稿**(Claude 按需求判断快速出清单,用户授权;**项目完成后需回来重新 review 和迭代**,见每个模块顶部标记)

**第 3 章下一步**:
- 回填 3.末 "MVP 范围总览 + 工作量感知"(把所有 P0 汇总 + 粗略工作量估计)
- 标记第 3 章 整体 完稿

**然后进入第 4 章(核心数据模型)**:这一章是"把 G18-G27 + B9/B6/C4 状态机 + 图钉/蓝点/拜访/工具/主题 等实体落成 schema"的关键章。

备忘箱当前累积:
- **G 类**(跨章悬案):G4、G9、G12、G13、G15-G28(共 15 项;其中 G3、G14 已关闭)
- **F 类**(候选功能):F1-F7

第 4 章起,G 类要陆续在对应章节兑现。
